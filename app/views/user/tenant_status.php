            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-dropdown-wrap">
                    ...
                    <div class="nav-dropdown open" id="apartment-menu">
                        ...
                        <a href="tenant_status.php" class="active" style="color:white;font-weight:600;">
                            <svg viewBox="0 0 24 24" fill="currentColor">
      ...
      `;
        ...
        <div class="parking-section">
          <div class="card-header">
            ...
            <a href="tenant_parking.php" class="btn-action outline" style="font-size:0.75rem;padding:6px 14px;min-height:auto;text-decoration:none;">
        ...
        <div class="action-bar">
          ...
          <div class="action-bar-btns">
            ...
            ${docsUploaded < docsTotal
                    ? `<a href="tenant_add_information_form.php" class="btn-action primary">
      ...
      `;
        ...
        function renderParkingApps() {
          ...
          <div class="parking-empty">
            ...
            <a href="tenant_parking.php" class="btn-apply">
