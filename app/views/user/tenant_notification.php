    ...
    <div class="app-wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="<?= url('/user/dashboard') ?>" class="nav-item" data-tooltip="Profile">
                    <svg viewBox="0 0 24 24" fill="currentColor">
                        <path
                ...
                <a href="tenant_notification.php" class="nav-item active" data-tooltip="Notifications">
                    <svg viewBox="0 0 24 24" fill="currentColor">
                        <path
      ...
      `;
        ...
        if (dawahMenu && dawahTrigger) {
            if (user.gender === 'female') {
                dawahMenu.innerHTML = `
                <a href="<?= url('/user/counseling-female') ?>">
                ...
                dawahMenu.innerHTML = `
                <a href="<?= url('/user/counseling-male') ?>">
                    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>
                    Brothers' Counseling
                </a>`;
