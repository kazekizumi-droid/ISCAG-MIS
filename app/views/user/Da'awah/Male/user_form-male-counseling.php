    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-dropdown-wrap">
        ...
        <div class="nav-dropdown open" id="dawah-menu">
          <a href="<?= url('/user/counseling-male') ?>" style="color:white;font-weight:600;">
            <svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>
            Brothers' Counseling
          </a>
        </div>
...
<script>
  ...
  if (percentage < 100) {
    ...
    document.getElementById('acm-primary-btn').addEventListener('click', () => { window.location.href = '<?= url(''/user/dashboard'') ?>'; });
