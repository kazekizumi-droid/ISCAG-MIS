      ...
      <nav class="sidebar-nav">
        ...
        <div class="nav-dropdown-wrap">
          ...
          <div class="nav-dropdown open" id="apartment-menu">
                        <a href="tenant_add_information_form.php" class="active" style="color:white;font-weight:600;">
                            <svg viewBox="0 0 24 24" fill="currentColor">
              ...
              <div class="unit-cards">
                <label class="unit-card selected" for="unit1">
                  ...
                  <div class="unit-card-thumb">
                    <img src="<?= asset('assets/room-images/studio-1.png') ?>" alt="Studio Unit Preview" />
          ...
          ">
            ...
            <div style="padding:28px 32px;">
              ...
              <div style="display:flex;gap:12px;justify-content:center;">
                ...
                <a href="tenant_status.php" style="
                  display:inline-flex;align-items:center;gap:8px;
                  padding:11px 24px;border-radius:8px;
                  background:linear-gradient(135deg,var(--primary-dark),var(--primary-light));
                  color:white;font-size:0.85rem;font-weight:700;
