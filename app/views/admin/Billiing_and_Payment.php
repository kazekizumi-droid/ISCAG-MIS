  ...
  <div class="app-wrapper">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <a href="Billiing_and_Payment.php" class="nav-item active" data-tooltip="Billing">
          <svg viewBox="0 0 24 24" fill="currentColor">
            <path
        ...
        <a href="Admin_Dashboard.php#activity" class="nav-item" data-tooltip="Logs" onclick="scrollToSection('activity-section')">
          <svg viewBox="0 0 24 24" fill="currentColor">
            <path
              d="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9z" />
          </svg>
        ...
        <a href="Admin_Dashboard.php#staff" class="nav-item" data-tooltip="Staff" onclick="scrollToSection('staff-section')">
          <svg viewBox="0 0 24 24" fill="currentColor">
            <path
