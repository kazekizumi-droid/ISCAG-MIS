  ...
  <div class="app-wrapper">
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <a href="apartment_records.html" class="nav-item active" data-tooltip="Apartment">
          <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <a href="damayan_records.html" class="nav-item" data-tooltip="Damayan">
          <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    <div class="main-content">
      ...
      <div class="page-body">
        <div class="breadcrumb-bar">
          <a href="../Admin_Dashboard.html">MIS Admin</a><span class="sep">›</span><span class="current">Apartment
            Records</span>
        </div>
