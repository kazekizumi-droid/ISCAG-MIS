  ...
  <div class="app-wrapper">
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <a href="daawah_records.html" class="nav-item active" data-tooltip="Da'wah">
          <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    <div class="main-content">
      ...
      <div class="page-body">
        <div class="breadcrumb-bar">
          <a href="../Admin_Dashboard.html">MIS Admin</a><span class="sep">›</span><span class="current">Da'wah
            Records</span>
        </div>
