  ...
  <div class="app-wrapper">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <a href="admin_reports.html" class="nav-item active" data-tooltip="Reports">
          <svg viewBox="0 0 24 24" fill="currentColor">
            <path
    ...
    <div class="main-content">
      <div class="top-bar">
        ...
        <div class="top-bar-actions">
          <a href="Admin_Dashboard.html" class="btn-topbar">← Dashboard</a>
      ...
      <div class="page-body">
        ...
        <div class="breadcrumb-bar">
          <a href="Admin_Dashboard.html">Dashboard</a><span class="sep">›</span>
