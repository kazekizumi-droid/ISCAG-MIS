...
.sidebar-brand .brand-logo svg { width: 20px; height: 20px; fill: white; }
...
.stat-icon.blue { background: rgba(30,95,139,0.1); }
.stat-icon.blue svg { fill: var(--info); }
.stat-icon.gold { background: rgba(201,168,76,0.12); }
.stat-icon.gold svg { fill: var(--warning); }
.stat-icon.green { background: rgba(46,125,85,0.1); }
.stat-icon.green svg { fill: var(--success); }
.stat-icon.red { background: rgba(139,46,46,0.1); }
...
.activity-text strong { font-size: 0.87rem; color: var(--text-main); }
.activity-text span { display: block; font-size: 0.78rem; color: var(--text-muted); margin-top: 2px; }
          ...
          <div class="section-card">
            ...
            <div class="section-card-body">
              <div style="display:flex;flex-direction:column;gap:10px;">
                ...
                <?php if (Auth::hasRole(['Admin', 'Staff_Tenant'])): ?>
                <a href="#" class="btn-topbar btn-outline-sm" style="justify-content:center;padding:12px;">
                  <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M17 11V3H7v4H3v14h8v-4h2v4h8V11h-4z"/></svg>
                ...
                <?php if (Auth::hasRole('Admin')): ?>
                <a href="#" class="btn-topbar btn-outline-sm" style="justify-content:center;padding:12px;">
                  <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3z"/></svg>
                  Manage Users
                </a>
                <?php endif; ?>
              </div>
